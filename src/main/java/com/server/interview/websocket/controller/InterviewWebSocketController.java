...
public class InterviewWebSocketController {
    ...
    public void handleChatMessage(@DestinationVariable Long interviewId, @Valid @Payload ChatMessage message) {
    ...
    public void handleSystemMessage(@DestinationVariable Long interviewId, @Valid @Payload SystemMessage message) {
