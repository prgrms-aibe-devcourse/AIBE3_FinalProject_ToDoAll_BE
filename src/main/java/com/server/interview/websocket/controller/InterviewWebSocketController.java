...
public class InterviewWebSocketController {
    ...
    public void handleChatMessage(@DestinationVariable Long interviewId, @Valid ChatMessage message) {
        interviewWebSocketService.broadcastChatMessage(interviewId, message);
    }


    @MessageMapping("/interview/{interviewId}/note")
    public void handleNoteMessage(@DestinationVariable Long interviewId, @Valid NoteMessage message, SimpMessageHeaderAccessor headerAccessor) {
    ...
    public void handleSystemMessage(@DestinationVariable Long interviewId, @Valid SystemMessage message) {
