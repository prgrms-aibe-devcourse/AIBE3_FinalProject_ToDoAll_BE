...
public class AiInterviewService {
    ...
    public void generateQuestions(Long interviewId) {
        ...
        try {
            ...
            log.error("[AI] generateQuestions FAILED interviewId={}, reason={}", interviewId, e.getMessage(), e);
            throw e;
        } finally {
            log.info("[AI] generateQuestions END interviewId={} duration={}ms", interviewId, System.currentTimeMillis() - start);
        }
    }
