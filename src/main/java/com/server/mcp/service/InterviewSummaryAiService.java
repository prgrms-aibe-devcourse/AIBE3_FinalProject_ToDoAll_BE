...
public class InterviewSummaryAiService {
    ...
    public void generateSummary(Long interviewId) {
        ...
        log.info("[AI] generateSummary START interviewId={}", interviewId);
        ...
        try {
            ...
            log.info("[AI] LLM Response (raw summary): {}", response);

        } catch (Exception e) {
            log.error("[AI] generateSummary FAILED interviewId={}, reason={}", interviewId, e.getMessage(), e);
            throw e;
        } finally {
            log.info("[AI] generateSummary END interviewId={} duration={}ms",
                    interviewId, System.currentTimeMillis() - start);
        }
    }
